...
<html>
  <head>
    ...
    <title>SAG | TRANSAKSI MASUK</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Product Receipt</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Product Receipt</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php foreach ($receipt as $re) { ?>
                    <tr>
                      <td><?php echo $re['kd_transmsk'];?></td>
                      ...
                      <td>
                        ...
                        <a href="<?php echo base_url().'index.php/Inventory/do_delete_trans_receipt/'.$re['kd_transmsk'];?>" data-toggle="tooltip" title="Delete">
