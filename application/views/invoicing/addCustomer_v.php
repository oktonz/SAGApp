      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/invoicing/do_add_cust';?>">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="kd_sup" class="col-sm-2 control-label">Kode Customers</label>
                      <div class="col-sm-3">
                        <input type="text" class="form-control" name="txtkdcust" placeholder="Kode Customer" disabled>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="nama_sup" class="col-sm-2 control-label">Nama Customers</label>
                      <div class="col-sm-6">
                        <input type="text" class="form-control" name="txtcust" placeholder="Nama Customer" autofocus>
                      </div>
                    </div>
                    <div class="form-group">
