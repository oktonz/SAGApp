      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="box box-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/purchasing/do_add_supp';?>">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="kd_sup" class="col-sm-2 control-label">Kode Supplier</label>
                      <div class="col-sm-3">
                        <input type="text" class="form-control" name="txtkdsup" placeholder="Kode Supplier" disabled>
                      </div>
                    </div>
                    <div class="form-group">
